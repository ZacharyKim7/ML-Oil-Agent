...
if __name__ == "__main__":
    """
    df_raw data frame header:
    Date,WTI ($/bbl),Brent ($/bbl),OPEC P (tbbl/d),NOPEC P (tbbl/d),OECD C (tbbl/d),China C (tbbl/d),India C (tbbl/d),OECD S (mbbl),USA S (mbbl),US net imports (tbbl/d),USA rigs (m),CPI,GDP (yoy%),USD-GBP,USD-YEN,Population
    """
